...
<section class="bg-white h-[804px] flex flex-col items-center justify-center gap-[39px] px-4">
    {{-- Judul --}}
    <h2 class="text-[40px] font-bold text-center leading-[48px] h-[53px]">Paket Camping</h2>
    ...
    <div class="flex flex-row gap-[56px] justify-center items-center w-[695.92px] overflow-hidden">
        ...
        <div class="relative w-[220.83px] h-[365px] bg-light p-4 text-[25px] leading-[24px] text-black">
            ...
            <p>Tersedia juga : <br>
                Sewa tenda Rp 50.000/tenda</p>
        </div>
    </div>

    {{-- Harga --}}
    <div class="text-center h-[58px] flex flex-col items-center justify-center">
        <div class="text-[20px] font-bold leading-[121.2%] tracking-[-0.015em]">1 Hari 1 Malam Rp 20.000,00/orang</div>
    </div>
    {{-- Tombol Navigasi --}}
    <div class="flex flex-row justify-between items-center w-full max-w-[1200px] mt-6 px-[60px]">
        ...
        {{-- Tombol Pesan --}}
        <div class="flex items-center gap-4">
            <a href="{{ route('formbooking', ['paket' => 'Paket Camping']) }}" class="bg-button text-white text-[14px] font-bold px-[40px] py-[10px] rounded-full w-[280px] h-[42px] flex items-center justify-center hover:bg-hover-button transition">
                Pesan
            </a>
